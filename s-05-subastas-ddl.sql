--- @Autor : 	Ricardo Rosales Romero , Suárez Espinoza Mario Alberto
--  @Fecha creacion: 13/02/21
--  @Descripcion:  Creando DDL Proyecto Subastas
...
CREATE TABLE CUENTA_BANCARIA(
    ...
    USING INDEX(
		CREATE UNIQUE INDEX CUENTA_BANCARIA_PK on CUENTA_BANCARIA(CUENTA_BANCARIA_ID)
		TABLESPACE ADMIN_USR_INDEX_TS	
	), 
    CONSTRAINT USUARIO_USUARIO_ID_FK FOREIGN KEY (USUARIO_ID)
    REFERENCES USUARIO(USUARIO_ID),
    CONSTRAINT BANCO_BANCO_ID_FK FOREIGN KEY (BANCO_ID)
...
CREATE TABLE TARJETA_BANCARIA(
    TARJETA_BANCARIA_ID    VARCHAR2(40)     NOT NULL,
    ...
    USING INDEX(
		CREATE UNIQUE INDEX TARJETA_BANCARIA_PK on TARJETA_BANCARIA(TARJETA_BANCARIA_ID)
		TABLESPACE ADMIN_USR_INDEX_TS	
	), 
    CONSTRAINT USUARIO_USUARIO_ID_FK FOREIGN KEY (USUARIO_ID)
    REFERENCES USUARIO(USUARIO_ID),
...
CREATE TABLE FACTURA(
    ...
    TARJETA_BANCARIA_ID    VARCHAR2(40),
    CONSTRAINT FACTURA_PK PRIMARY KEY (FACTURA_ID)USING INDEX(
		CREATE UNIQUE INDEX FACTURA_PK  on FACTURAFACTURA_ID)
		TABLESPACE ADMIN_USR_INDEX_TS	
	), 
    CONSTRAINT USUARIO_USUARIO_ID_FK FOREIGN KEY (USUARIO_ID)
    REFERENCES USUARIO(USUARIO_ID),
    CONSTRAINT CUENTA_BANCARIA__CUENTA_BANCARIA_ID_FK FOREIGN KEY (CUENTA_BANCARIA_ID)
    REFERENCES CUENTA_BANCARIA(CUENTA_BANCARIA_ID),
    CONSTRAINT TARJETA_BANCARIAFOREIGN_TARJETA_BANCARIA_ID_FK KEY (TARJETA_BANCARIA_ID)
...
CREATE TABLE OBJETO(
    ...
    CODIGO_BARRAS_IMG       BLOB             NOT NULL,
    ...
    CONSTRAINT STATUS_OBJETO_STATUS_ACTUAL_ID_FK FOREIGN KEY (STATUS_ACTUAL_ID)
    REFERENCES STATUS_OBJETO(STATUS_OBJETO_ID),
    CONSTRAINT SUBASTA_SUBASTA_ID_FK FOREIGN KEY (SUBASTA_ID)
    REFERENCES SUBASTA(SUBASTA_ID),
    CONSTRAINT USUARIO_USR_VENDEDOR_ID_FK FOREIGN KEY (USR_VENDEDOR_ID)
    REFERENCES USUARIO(USUARIO_ID)
)TABLESPACE ADMIN_OBJ_TS;

--
--usar grant references on mse_admin_users.USUARIO to rrr_admin_objects;
--  
...
CREATE TABLE HACIENDA(
    ...
    CONSTRAINT OBJETO_HACIENDA_FK FOREIGN KEY (HACIENDA)
...
CREATE TABLE MARCA_AUTO(
    ...
    USING INDEX(
		CREATE UNIQUE INDEX AMARCA_AUTO_PK  on MARCA_AUTO(MARCA_AUTO_ID)
		TABLESPACE ADMIN_OBJ_INDEX_TS	
	),
)TABLESPACE ADMIN_OBJ_TS;
...
CREATE TABLE MODELO_AUTO(
    ...
    USING INDEX(
		CREATE UNIQUE INDEX MODELO_AUTO_PK  on MODELO_AUTO(MODELO_AUTO_ID)
		TABLESPACE ADMIN_OBJ_INDEX_TS	
	),
    CONSTRAINT MARCA_AUTO_MARCA_AUTO_ID_FK FOREIGN KEY (MARCA_AUTO_ID)
...
CREATE TABLE AUTO(
    ...
    CONSTRAINT OBJETO_OBJETO_ID_FK FOREIGN KEY (OBJETO_ID)
    REFERENCES OBJETO(OBJETO_ID),
    CONSTRAINT MODELO_AUTO_MODELO_AUTO_ID_FK FOREIGN KEY (MODELO_AUTO_ID)
...
CREATE TABLE FOTOGRAFIA_OBJETO(
    ...
    USING INDEX(
		CREATE UNIQUE INDEX FOTOGRAFIA_OBJETO_PK  on FOTOGRAFIA_OBJETO(FOTOGRAFIA_OBJETO_ID)
		TABLESPACE ADMIN_OBJ_INDEX_TS	
	),
    CONSTRAINT OBJETO_OBJETO_ID_FK FOREIGN KEY (OBJETO_ID)
    REFERENCES OBJETO(OBJETO_ID)
...
CREATE TABLE HISTORICO_STATUS_OBJETO(
    ...
    CONSTRAINT OBJETO_OBJETO_ID_FK FOREIGN KEY (OBJETO_ID)
    REFERENCES OBJETO(OBJETO_ID),
    CONSTRAINT STATUS_OBJETO_STATUS_OBJETO_ID_FK FOREIGN KEY (STATUS_OBJETO_ID)
    REFERENCES STATUS_OBJETO(STATUS_OBJETO_ID)
)TABLESPACE ADMIN_OBJ_TS;
...
CREATE TABLE OFERTA(
    ...
    CONSTRAINT OBJETO_OBJETO_ID_FK FOREIGN KEY (OBJETO_ID)
    REFERENCES OBJETO(OBJETO_ID),
    CONSTRAINT FACTURA_FACTURA_ID_FK FOREIGN KEY (FACTURA_ID)
